...
function CardDescriptionMdEditor({ cardDescriptionProp, handleUpdateCardDescription }) {
  ...
  // State xử lý giá trị markdown khi chỉnh sửa ở chế độ Edit (ở đây chúng ta sẽ không dùng trực tiếp prop cardDescriptionProp để tránh việc mất dữ liệu khi đang edit mà prop này thay đổi từ bên ngoài truyền vào)
